const hotels = [
  ...
  },
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1523699289804-55347c09047d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjZ8fGhvdGVsc3xlbnwwfHwwfHx8MA%3D%3D", "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aG90ZWxzfGVufDB8fDB8fHww", "https://images.unsplash.com/photo-1559508551-44bff1de756b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzJ8fGhvdGVsc3xlbnwwfHwwfHx8MA%3D%3D", "https://images.unsplash.com/photo-1544124499-58912cbddaad?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzh8fGhvdGVsc3xlbnwwfHwwfHx8MA%3D%3D"
    ],
  },
];
    ...
    listItem.innerHTML = `
      <div class="flex flex-col md:flex-row justify-between items-center">
        <div class="flex flex-col md:flex-row items-start">
          <div class="relative">
            <img src="${hotel.images[0]}" alt="${hotel.name} profile" class="w-80 h-60 object-cover rounded-lg border-2 border-gray-300">
            <div class="absolute top-0 right-0 flex flex-col space-y-2 p-2">
              <img src="${hotel.images[1]}" alt="${hotel.name} image" class="w-16 h-16 object-cover rounded-lg border-2 border-gray-300">
              <img src="${hotel.images[2]}" alt="${hotel.name} image" class="w-16 h-16 object-cover rounded-lg border-2 border-gray-300">
              <img src="${hotel.images[3]}" alt="${hotel.name} image" class="w-16 h-16 object-cover rounded-lg border-2 border-gray-300">
            </div>
          </div>
          <div class="ml-0 md:ml-6 mt-4 md:mt-0">
            <h1 class="text-2xl font-bold text-gray-800">${hotel.name}</h1>
            <p class="text-md text-gray-600"><strong>Location:</strong> ${hotel.address} - ${hotel["pin code"]}</p>
            <p class="text-md text-gray-600"><strong>Rating:</strong> ${hotel.rating}</p>
            <p class="text-md text-gray-600"><strong>Price:</strong> ₹${hotel.price} per night</p>
            <p class="text-md text-gray-600 mb-11"><strong>Amenities:</strong> ${hotel.amenities.join(", ")}</p>
